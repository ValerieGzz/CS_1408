...
Public Class Form1
    ...
    Private Sub btnCalculate_Click(sender As Object, e As EventArgs) Handles btnCalculate.Click
        ...
        Dim dblLoan As Double               ' Loan Amount
        Dim dblMonthlyPayment As Double     ' Monthly Payment
        Dim dblInterest As Double           ' Interets paid for the period
        Dim dblPrincipal As Double          ' Principal pid for the period
        Dim intCount As Integer             ' Counter for the loop
        Dim strOut As String                ' Used to hold the line of output
        Dim blnInputOk As Boolean = True    ' input flag
